...
public class AttachmentBuilder {
    ...
    public AttachmentBuilder(Map<ClassificationType, List<ClassificationImpl>> classifications, int maxAmountAttachments) {
        this(classifications, maxAmountAttachments, new ObjectReferenceBuilder(DEFAULT_AMOUNT_OBJECT_REFERENCES));
    }
    
    public AttachmentBuilder(Map<ClassificationType, List<ClassificationImpl>> classifications, ObjectReferenceBuilder objectReferenceBuilder) {
        this(classifications, 0, objectReferenceBuilder);
    }
    
    public AttachmentBuilder(Map<ClassificationType, List<ClassificationImpl>> classifications, int maxAmountAttachments, ObjectReferenceBuilder objectReferenceBuilder) {
