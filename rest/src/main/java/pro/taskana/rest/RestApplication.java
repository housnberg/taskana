...
import pro.taskana.rest.configuration.DataSourceHandler;
...
public class RestApplication {
    ...
    public TaskanaEngineConfiguration getTaskanaEngineConfiguration() throws SQLException {
    	DataSource ds = DataSourceHandler.getDataSource();
        TaskanaEngineConfiguration taskanaEngineConfiguration = new TaskanaEngineConfiguration(ds, true);
